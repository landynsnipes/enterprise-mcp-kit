...
const input = { actionType: 'netbox.device.update', target: { kind: 'netbox-device', id: '7' }, proposedChange: 'Change role.', confidence: 0.8, evidence: [{ source: 'api/dcim/devices/7/', summary: 'Current role.' }], ruleVersion: 'v1', promptVersion: null, expiresAt: '2026-12-01T00:00:00.000Z' };
